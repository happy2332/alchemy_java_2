...
public class CreateHyperCubeBasic {
	...
	public boolean isHyperCubePresent(HyperCube hyperCube, int varId, HashMap<HyperCube,ArrayList<HyperCube>> hyperCubeHashMap){
		TreeSet<Integer>origVarConstant = hyperCube.varConstants.get(varId);
		hyperCube.setVarConstants(new TreeSet<Integer>(Arrays.asList(-1)), varId);
	...
	public void addHyperCubeToVarHashMap(HyperCube hyperCube, int varId, HashMap<HyperCube,ArrayList<HyperCube>> hyperCubeHashMap, Set<HyperCube> set){
		...
		keyHyperCube.setVarConstants(new TreeSet<Integer>(Arrays.asList(-1)), varId);
	...
	public void createDisjointHyperCubesVar(int varId, int h1Id, int h2Id, ArrayList<ArrayList<Integer>> hyperCubesIntersectionList, ArrayList<HyperCube>hyperCubes){
		...
		TreeSet<Integer>hc1VarConstants = new TreeSet<Integer>(h1.varConstants.get(varId));
		TreeSet<Integer>hc2VarConstants = new TreeSet<Integer>(h2.varConstants.get(varId));
	...
	public static void main(String[] args) {
		...
		s2.add(2);
		s2.add(3);
		ArrayList<TreeSet<Integer>> v1 = new ArrayList<TreeSet<Integer>>();
		v1.add(s1);
		v1.add(s2);
		hc.varConstants = v1;
		TreeSet<Integer>s3 = new TreeSet<Integer>(s1);
		TreeSet<Integer>s4 = new TreeSet<Integer>();
		s4.add(2);
		s4.add(4);
		ArrayList<TreeSet<Integer>> v2 = new ArrayList<TreeSet<Integer>>();
		v2.add(s3);
		v2.add(s4);
